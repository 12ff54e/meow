...
scripts/vmec_namelist_to_cumes_json.py \
  ...
  examples/landreman/qa.json --minimum-ftol 1e-16 \
...
scripts/vmec_namelist_to_cumes_json.py \
  ...
  examples/landreman/qh.json --minimum-ftol 1e-16 \
...
guess conventions; the fixed boundary coefficients are copied unchanged.
